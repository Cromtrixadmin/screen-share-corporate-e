...
const Verification: React.FC<VerificationProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black">
      <div className="w-full max-md p-10 bg-surface-dark border border-white/10 rounded-[2.5rem] shadow-2xl flex flex-col items-center text-center">
        <div className="relative mb-10 flex flex-col items-center">
          ...
          <div className="mt-4 px-5 py-2 rounded-full flex items-center gap-2.5 border border-white/5 bg-transparent">
            ...
            <span className="text-xs font-bold text-white tracking-wide">Scanning Identity...</span>
          </div>
        </div>
        ...
        <div className="mt-10 mb-2 flex flex-col w-full gap-4">
          ...
          <div className="flex justify-between text-[11px] font-bold text-slate-500 tracking-tight">
